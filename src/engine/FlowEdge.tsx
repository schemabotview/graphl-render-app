...
// like a hand-drawn reference on a dense 2D map. (Standard React Flow floating math.)
...
// directional cue. Endpoints float to the facing borders; two ends on the SAME side
// use an orthogonal step so the edge doesn't fold back. data.animated=false = static.
